      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-6">
            <Link
              to="/help"
              className="hidden lg:flex items-center space-x-2 text-gray-700 hover:text-orange-500 font-medium"
            >
                  ...
                  <div className="absolute right-0 mt-3 w-64 bg-white rounded-lg shadow-xl border py-2 z-50">
                    ...
                    {isOwner && (
                      <Link
                        to="/owner/dashboard"
                        onClick={() => setShowDropdown(false)}
                        className="flex items-center space-x-3 px-4 py-3 text-orange-600 hover:bg-orange-50"
                      >
